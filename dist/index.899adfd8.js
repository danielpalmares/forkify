...
const showRecipes = async function () {
  try {
    ...
    const res = await fetch('https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bc886'); // https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bc886
    ...
    console.log(recipe); // 2) Rendering the recipe
